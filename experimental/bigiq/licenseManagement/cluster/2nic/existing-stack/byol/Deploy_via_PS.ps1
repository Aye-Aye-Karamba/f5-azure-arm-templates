...
## Example Command: .\Deploy_via_PS.ps1 -adminUsername azureuser -adminPassword P@ssw0rd! -masterKey <value> -dnsLabel <value> -instanceName f5vm01 -instanceType Standard_D4s_v3 -bigIqVersion 7.0.010000 -bigIqLicenseKey1 <value> -bigIqLicenseKey2 <value> -licensePoolKeys Do_Not_Create -regPoolKeys Do_Not_Create -vnetName <value> -vnetResourceGroupName <value> -userAssignedIdentityResourceGroupName <value> -userAssignedIdentityName <value> -mgmtSubnetName <value> -mgmtIpAddressRangeStart <value> -internalSubnetName <value> -internalIpSelfAddressRangeStart <value> -internalIpAddressRangeStart <value> -ntpServer 0.pool.ntp.org -timeZone UTC -customImage OPTIONAL -allowUsageAnalytics Yes -resourceGroupName <value>
...
param(
  ...
  [string] [Parameter(Mandatory=$True)] $userAssignedIdentityResourceGroupName,
  [string] [Parameter(Mandatory=$True)] $userAssignedIdentityName,
  ...
  [string] [Parameter(Mandatory=$True)] $internalIpSelfAddressRangeStart,
...
$deployment = New-AzureRmResourceGroupDeployment -Name $resourceGroupName -ResourceGroupName $resourceGroupName -TemplateFile $templateFilePath -TemplateParameterFile $parametersFilePath -Verbose -adminUsername $adminUsername -adminPassword $adminPasswordSecure -masterKey $masterKeySecure -dnsLabel $dnsLabel -instanceName $instanceName -instanceType $instanceType -bigIqVersion $bigIqVersion -bigIqLicenseKey1 $bigIqLicenseKey1 -bigIqLicenseKey2 $bigIqLicenseKey2 -licensePoolKeys $licensePoolKeys -regPoolKeys $regPoolKeys -vnetName $vnetName -vnetResourceGroupName $vnetResourceGroupName -userAssignedIdentityResourceGroupName $userAssignedIdentityResourceGroupName -userAssignedIdentityName $userAssignedIdentityName -mgmtSubnetName $mgmtSubnetName -mgmtIpAddressRangeStart $mgmtIpAddressRangeStart -internalSubnetName $internalSubnetName -internalIpSelfAddressRangeStart $internalIpSelfAddressRangeStart -internalIpAddressRangeStart $internalIpAddressRangeStart -ntpServer $ntpServer -timeZone $timeZone -customImage $customImage -restrictedSrcAddress $restrictedSrcAddress -tagValues $tagValues -allowUsageAnalytics $allowUsageAnalytics 
